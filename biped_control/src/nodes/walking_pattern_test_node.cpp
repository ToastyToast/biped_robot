...
{
    ros::init(argc, argv, "walking_pattern_test_node");
    ros::NodeHandle nh("");
    ...
    ROS_INFO("Starting walking_pattern_test_node");
    
    float dt = 0.01f;
    
    LIP3D lip(0.01f, 0.1f, 0.0f, 0.0f);
    lip.setPlaneConstraint(0.0f, 0.0f, 0.8f);
    
    WalkPattern::FootPosition foot_pos(0.0, 0.0f);
