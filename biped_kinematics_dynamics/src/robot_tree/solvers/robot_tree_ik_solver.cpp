...
void RobotTreeIKSolver::cartesianToJoint(const std::string& link_name, Eigen::Vector3f target_pos, Eigen::Quaternionf target_rot)
{
    auto ankle_link = m_robot_tree_ptr->findLink(link_name);
